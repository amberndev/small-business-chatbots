...
export const realEstate: ChatbotConfig = {
  ...
  knowledgeBase: [
    ...
    { topic: "viewings", question: "How can I arrange a viewing?", answer: "You can demonstrate a viewing enquiry by submitting preferences and a preferred date and period. This records a simulated request only. The sample calendar offers fictional dates and times. There is no live inventory, property reservation or confirmed viewing.", keywords: ["viewing", "visit", "inspection", "appointment", "book"] },
    { topic: "listings", question: "Which properties are available?", answer: "Explore the fictional Riverside Gardens catalogue above. It includes homes for sale and rent, sold and rented examples, price and bedroom filters, and an illustrative neighbourhood map. Select an available home to request a simulated viewing. No listing, price or availability is real.", keywords: ["listings", "available", "availability", "properties", "houses", "apartments", "stock"] },
